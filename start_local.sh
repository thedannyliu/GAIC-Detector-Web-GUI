...
echo ""
echo "   ssh -N -L 7860:localhost:7860 -L 8000:localhost:8000 -J ${USERNAME}@login-phoenix-slurm.pace.gatech.edu ${USERNAME}@${HOSTNAME}"
echo ""
...
echo "   ssh -L 7860:${HOSTNAME}:7860 -L 8000:${HOSTNAME}:8000 ${USERNAME}@login-phoenix-slurm.pace.gatech.edu"
echo ""
