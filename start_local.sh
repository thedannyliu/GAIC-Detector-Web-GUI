...
echo "════════════════════════════════════════════════════════════════"
echo ""
echo "1️⃣  在你的【本地電腦】打開新的終端，執行以下命令："
echo ""
echo "   ssh -N -L 7860:localhost:7860 -L 8000:localhost:8000 ${USERNAME}@login-phoenix-slurm.pace.gatech.edu"
echo ""
